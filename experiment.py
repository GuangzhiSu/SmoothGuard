...
def parse_args():
    parser = argparse.ArgumentParser(description="Experiment for sigma selection")
    ...
    parser.add_argument("--output_file", type=str, default='./result_sigma', help="Output file prefix.")
...
def main():
    ...
    for sigma in sigma_values:
        ...
        output_file = f"{args.output_file}_sigma{sigma:.2f}.jsonl"
