...
def process_images(images, image_processor, model_cfg, sigma=0.00, noise_enabled=True, num_copy=5):
    """
    ...
    if noise_enabled:
        new_images = _apply_random_smoothing(processed_images, sigma, num_copy)
