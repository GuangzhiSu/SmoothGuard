...
python3 /home/gs285/MLLM-defense-using-random-smoothing/eval/model_vqa_loader_new.py \
    ...
    --answers-file /home/gs285/MLLM-defense-using-random-smoothing/eval/bench-in-the-wild/answers/Qwen2.5-VL-7B-Instruct-new.jsonl \
    --sigma 0.1 \
    --num-copy 10 \
    --device cuda \
    --max-new-tokens 256
...
python3 /home/gs285/MLLM-defense-using-random-smoothing/eval/bench-in-the-wild/eval_wildbench_qwen.py \
    ...
    --answer-list \
        ...
        /home/gs285/MLLM-defense-using-random-smoothing/eval/bench-in-the-wild/answers/Qwen2.5-VL-7B-Instruct-new.jsonl \
    --output \
        /home/gs285/MLLM-defense-using-random-smoothing/eval/bench-in-the-wild/reviews/Qwen2.5-reviews-new.jsonl

python3 /home/gs285/MLLM-defense-using-random-smoothing/eval/bench-in-the-wild/summarize_gpt_review.py -f /home/gs285/MLLM-defense-using-random-smoothing/eval/bench-in-the-wild/reviews/Qwen2.5-reviews-new.jsonl
